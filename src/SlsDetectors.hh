...
#ifndef KARABO_SLSDETECTORS_HH
#define KARABO_SLSDETECTORS_HH
...
namespace karabo {
    ...
    class SlsDetectors : public karabo::core::Device<> {

    public:

        // Add reflection information and Karabo framework compatibility to this class
        KARABO_CLASSINFO(SlsDetectors, "SlsDetectors", "2.0")
         ...
         */
        SlsDetectors(const karabo::util::Hash& config);

        /**
         * The destructor will be called in case the device gets killed
         */
        virtual ~SlsDetectors();
