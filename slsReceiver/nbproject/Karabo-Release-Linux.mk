...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/src/tests/SlsReceiverTest.o ${TESTDIR}/src/tests/test_runner.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} -L${KARABO}/lib -L${KARABO}/extern/lib64 -L${KARABO}/extern/lib -Wl,-rpath,${KARABO}/lib -Wl,-rpath,${KARABO}/extern/lib64 -Wl,-rpath,${KARABO}/extern/lib `pkg-config cppunit --libs`   
