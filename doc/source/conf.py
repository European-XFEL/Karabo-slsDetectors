...
# -*- coding: utf-8 -*-
#
# SLS Detector documentation build configuration file, created by
...
#
# html_title = 'SLS Detector vtrunk'
...
htmlhelp_basename = 'SLSDetectordoc'
...
latex_documents = [
    (master_doc, 'SLSDetector.tex', 'SLS Detector Documentation',
     'A. Parenti', 'manual'),
]
...
man_pages = [
    (master_doc, 'slsdetector', 'SLS Detector Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SLSDetector', 'SLS Detector Documentation',
     author, 'SLSDetector', 'One line description of project.',
     'Miscellaneous'),
]
